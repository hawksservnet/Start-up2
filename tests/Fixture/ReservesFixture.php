...
class ReservesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reserve_status' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'cancel_status' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'cancel_date' => ['type' => 'timestamp', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'reserves_uk1' => ['type' => 'unique', 'columns' => ['work_date', 'work_time_start', 'concierge_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'reserve_status' => 1,
            'cancel_status' => 0,
            'cancel_date' => 1503284337,
            'created_id' => 1,
            'created_date' => 1503284337,
            'modified_id' => 1,
            'modified_date' => 1503284337
        ],
    ];
}
