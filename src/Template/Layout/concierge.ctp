...
$pageHeadInfo = [
    'title' => 'Startup Hub Tokyo（スタートアップハブ東京）',
    'keywords' => '',
    'description' => 'Startup Hub　Tokyoでは、起業を具体的に準備している人から、まだ検討段階の人まで、「これから起業しよう！」という思いを持っている人を手厚くサポートする施設です。'
];
if (!empty($pageInfo[$prefix . '|' . $controller . '|' .$action])) {
    $pageHeadInfo = $pageInfo[$prefix . '|' . $controller . '|' .$action];
}
?>
<!DOCTYPE html>
<html lang="ja">
<head>
    ...
    <!-- META -->
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="/assets-sht2/img/common/_meta/apple-touch-icon-57x57.png" />
    <link rel="apple-touch-icon-precomposed" sizes="60x60" href="/assets-sht2/img/common/_meta/apple-touch-icon-60x60.png" />
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="/assets-sht2/img/common/_meta/apple-touch-icon-72x72.png" />
    <link rel="apple-touch-icon-precomposed" sizes="76x76" href="/assets-sht2/img/common/_meta/apple-touch-icon-76x76.png" />
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/assets-sht2/img/common/_meta/apple-touch-icon-114x114.png" />
    <link rel="apple-touch-icon-precomposed" sizes="120x120" href="/assets-sht2/img/common/_meta/apple-touch-icon-120x120.png" />
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/assets-sht2/img/common/_meta/apple-touch-icon-144x144.png" />
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="/assets-sht2/img/common/_meta/apple-touch-icon-152x152.png" />
    <link rel="icon" type="image/png" href="/assets-sht2/img/common/_meta/favicon-16x16.png" sizes="16x16" />
    <link rel="icon" type="image/png" href="/assets-sht2/img/common/_meta/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="/assets-sht2/img/common/_meta/favicon-96x96.png" sizes="96x96" />
    <link rel="icon" type="image/png" href="/assets-sht2/img/common/_meta/favicon-196x196.png" sizes="196x196" />
    <meta name="application-name" content="&nbsp;"/>
    <meta name="msapplication-TileImage" content="/assets-sht2/img/common/_meta/mstile-144x144.png">
    ...
    <meta property="og:description" content="$pageHeadInfo['description']?>" />
    <meta property="og:site_name" content="Startup Hub Tokyo（スタートアップハブ東京）" />
    <meta property="og:image" content="/assets-sht2/img/common/_meta/ogp.png" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="$pageHeadInfo['description']?>" />
    <meta name="twitter:title" content="<?=$pageHeadInfo['title']?>" />
    <meta name="twitter:site" content="Startup Hub Tokyo（スタートアップハブ東京）" />
    <meta name="twitter:image" content="/assets-sht2/img/common/_meta/ogp.png" />
    <!-- SEO END -->
    ...
    <script src="<?= $this->Html->getVersion('/js/jquery.js'); ?>"></script>
    <script src="<?= $this->Html->getVersion('/assets-sht2/js/head.js'); ?>"></script>

    <link rel="stylesheet" type="text/css" href="<?= $this->Html->getVersion('/assets-sht2/css/style.css'); ?>">
    <link rel="stylesheet" href="<?= $this->Html->getVersion('/css/front.css'); ?>" />
    ...
    <script>
        ...
        function callFuel() {
            $.ajax({
                url: '<?=Configure::read('FUEL_ADMIN_URL') . 'ajaxsession/keep'?>',
                type: "GET",
                dataType: "json",
                xhrFields: {
                ...
                success: function (data) {
                    if (data.flag==0){
                        location.href='<?=Configure::read('FUEL_ADMIN_URL') . 'users/logout'?>';
                    }
                },
            });
        }
            ...
            <div id="header-inner">
                ...
                <div id="head-navi-container" class="clearfix">
                    <div id="gnavi-head" class="clearfix pc">
                        <?php if(isset($loginInfo) && is_array($loginInfo)): ?>
                            <p class="mypage min"><a href="<?=Configure::read('FUEL_ADMIN_URL') ?>mypage/">MY PAGE</a></p>
                            <p class="logout min"><a href="<?=Configure::read('FUEL_ADMIN_URL') ?>users/logout">LOGOUT</a></p>
                        <?php else: ?>
                            <p class="mypage"><a href="<?=Configure::read('FUEL_ADMIN_URL') ?>users/login">MY PAGE</a></p>
                        <?php endif; ?>
                    ...
                    <div id="head-navi-container-inner">
                        <div id="head-navi-scroll">
                            ...
                            <nav id="gnavi">
                                <ul class="clearfix">
                                    <li><a href="/vision/"><span class="js__container"><span class="js__child">VISION</span></span></a></li>
                                    <li><a href="/service/"><span class="js__container"><span class="js__child">SERVICE</span></span></a></li>
                                    <li><a href="/how_to_join/"><span class="js__container"><span class="js__child">HOW TO JOIN</span></span></a></li>
                                    <li><a href="/pre-entre/"><span class="js__container"><span class="js__child">PRE ENTRE</span></span></a></li>
                                    <li><a href="/facility-guide/"><span class="js__container"><span class="js__child">FACILITYGUIDE</span></span></a></li>

                                    <li><a href="/event/"><span class="js__container"><span class="js__child">EVENTS</span></span></a></li>
                                    <li><a href="/concierge/"><span class="js__container"><span class="js__child">CONCIERGE</span></span></a></li>
                                    <li ><a href="/role-model/"><span class="js__container"><span class="js__child">ROLE MODEL</span></span></a></li>
                                    <li><a href="/magazine/"><span class="js__container"><span class="js__child">MAGAZINE</span></span></a></li>
                                    <li><a href="/access/"><span class="js__container"><span class="js__child">ACCESS</span></span></a></li>
                                    <li><a href="/information/"><span class="js__container"><span class="js__child">INFORMATION</span></span></a></li>

                                    <li><a href="/contact/"><span class="js__container"><span class="js__child">CONTACT US</span></span></a></li>
                                </ul>
                            </nav><!-- /#gnavi -->
                            ...
                            <div class="js__container"><div class="js__child">
                                    <div class="btn min js__mark">
                                        <div class="btn-inner clear white">
                                            <a href="<?=Configure::read('FUEL_ADMIN_URL') ?>users/registration.php">
                ...
                <?php if(isset($loginInfo) && is_array($loginInfo)): ?>
                    <p id="sp-mypage" class="sp min">
                        <a href="<?=Configure::read('FUEL_ADMIN_URL') ?>mypage/" class="mypage"></a>
                        <a href="<?=Configure::read('FUEL_ADMIN_URL') ?>users/logout" class="logout"></a>
                    </p>
                <?php else: ?>
                    <p id="sp-mypage" class="sp"><a href="<?=Configure::read('FUEL_ADMIN_URL') ?>users/login">MY PAGE</a></p>
                <?php endif; ?>
                ...
                <div id="footer-inner" class="clearfix">
                    ...
                    <div class="text-wrap clearfix">
                        ...
                        <ul class="logo-container clearfix">
                            <li class="tokyoto-logo"><a href="http://www.metro.tokyo.jp/" target="_blank"><img src="/assets-sht2/img/common/tokyoto-logo.svg" alt="東京都"></a></li>
                            <li class="tokyoto-logo"><a href="http://www.tokyo-sogyo-net.jp/" target="_blank"><img src="/assets-sht2/img/common/tokyo_net_icon.svg" alt="東京創業NET"></a></li>
                        </ul>
...
<!--
        <div id="fixed-btn" class="pc">
            <div class="btn h60 icon-none">
                <div class="btn-inner">
                    <a href="<?=Configure::read('FUEL_ADMIN_URL') ?>users/registration.php">
                        <span class="text en">メンバー<br><div>登録</div></span>
                    </a>
                    <div class="line"></div>
                    <div class="line2"></div>
                </div>
...
<script src="<?= $this->Html->getVersion('/assets-sht2/js/lib.js'); ?>"></script>
<script src="<?= $this->Html->getVersion('/assets-sht2/js/jquery.colorbox-min.js'); ?>"></script>
<script src="<?= $this->Html->getVersion('/assets-sht2/js/wp.app.js'); ?>"></script>
