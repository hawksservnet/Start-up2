...
.left-art::-webkit-scrollbar
{
    width: 8px;
}
.left-art::-webkit-scrollbar-thumb
{
    background-color: #717171;
}
.left-art::-webkit-scrollbar-track
{
    ...
    <div class="section-inner top-inner">
        <div class="section-contents">
            <section class="main-cont">
                            ...
                            <div class="fc-toolbar show fc-header-toolbar">
                                <div class="fc-left">
                                    <div class="fc-button-group">
                                        <button type="button"  onclick="window.location.href='<?php echo $this->Url->build(["controller" => "Index","action" => "index",'?'=>[ 'id'=>$id,'dt'=> $yearPrv.'-'.$monthPrv.'-01']]);?>'" class="fc-prev-button fc-button fc-state-default fc-corner-left">
                                            <span class="fc-icon fc-icon-left-single-arrow"></span>
                                        </button>
                                        <button type="button"  onclick="window.location.href='<?php echo $this->Url->build(["controller" => "Index","action" => "index",'?' =>['id'=>$id,'dt' => $yearNext.'-'.$monthNext.'-01']]);?>'" class="fc-next-button fc-button fc-state-default fc-corner-right">
                                    ...
                                    <?php if (!$istoday) :?>
                                        <button type="button"
                                                ...
                                                onclick="window.location.href='<?php echo $this->Url->build([ "controller" => "Index","action" => "index",'?' => ['id' => $id,'dt' =>$now->format('Y-m-d')]]);?>'"
                                        >今日</button>
                                    <?php else:?>
                                        <button type="button"
                ...
                <p class="title-pop view-mobile">
                    コンシェルジュ一覧
                </p>
                <article class="left-art">
                        <?=$this->element('concierge',[$concierges, $currentTime ]) ?>
                </article>
...
<script>
    ...
    $('#concierges').change(function () {
        var url = '<?php echo $this->Url->build([ "controller" => "Index","action" => "index"]);?>';
